      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <span className="pixel-font text-xs text-neon-cyan tracking-widest uppercase mb-4 block">
              // DATABASE
            </span>
            <h2 className="orbitron text-4xl md:text-5xl font-black text-white mb-4">
              STEAM BY THE <span className="text-neon-orange glow-orange">NUMBERS</span>
            </h2>
          </div>

          <div className="flex justify-center">
            <div className="terminal-box rounded-lg p-8 flex items-center gap-4">
              ...
              <span className="text-neon-cyan font-mono">LOADING STATISTICS...</span>
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="terminal-box rounded-lg overflow-hidden">
            <div className="terminal-header">
              <span className="text-gray-400 text-sm font-mono ml-16">GAMES.stat</span>
            </div>
            <div className="p-8">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-14 h-14 rounded-lg bg-neon-cyan/10 border border-neon-cyan/30 flex items-center justify-center">
                ...
                <div>
                  <h3 className="orbitron text-2xl font-bold text-white">GAMES</h3>
                  <p className="text-sm text-gray-500 font-mono">Steam library statistics</p>
                </div>
              </div>

              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {gameStats.map((stat) => (
                  <div key={stat.label} className="bg-terminal-dark rounded-lg p-4 border border-terminal-border">
                    <div className={`orbitron text-2xl sm:text-3xl font-bold mb-1 ${
          ...
          <div className="terminal-box rounded-lg overflow-hidden">
            <div className="terminal-header">
              <span className="text-gray-400 text-sm font-mono ml-16">USERS.stat</span>
            </div>
            <div className="p-8">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-14 h-14 rounded-lg bg-neon-green/10 border border-neon-green/30 flex items-center justify-center">
                ...
                <div>
                  <h3 className="orbitron text-2xl font-bold text-white">USERS</h3>
                  <p className="text-sm text-gray-500 font-mono">Community metrics</p>
                </div>
              </div>
        ...
        {/* Info banner */}
        <div className="terminal-box rounded-lg p-4 border-l-4 border-l-neon-orange">
